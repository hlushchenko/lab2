...
namespace lab2
{
    public class Student
    {
        ...
        public static Student[] Scholarship(Student[] students, int percent, double minimalRating) //this function shows, who gets money :)
        {
            ...
            {
                if (students[i].averageMark > minimalRating)
                {
